...
This function lists the variables available for a given dataset. Note
that the spelling and use of capitals in names might differ from the
original publications, as `pastclim` harmonises the names of variables
...
- details:
  ...
  boolean determining whether the output should include information

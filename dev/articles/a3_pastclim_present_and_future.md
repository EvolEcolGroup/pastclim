...
[`help("WorldClim_2.1")`](https://evolecolgroup.github.io/pastclim/dev/reference/WorldClim_2.1.md)
...
Help for the WorldClim datasets (modern and future) can be accessed with
[`help("CHELSA_2.1")`](https://evolecolgroup.github.io/pastclim/dev/reference/CHELSA_2.1.md)

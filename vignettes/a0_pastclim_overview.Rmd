...
points to every panel of the figure, we need to createa  function that is used as
an argument for `fun` within `plot`:
```{r, fig.width=6, fig.height=5}
plot(europe_climate_20k, fun=function() points(locations_vect, col="red", cex=2))
```

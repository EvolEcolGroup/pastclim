...
```{r eval=FALSE}
climate_present <- region_slice(time_ce=1985, 
                                bio_variables = c("bio01","bio02","altitude"), 
...
```{r eval=FALSE}
download_dataset(dataset="WorldClim_2.1_HadGEM3-GC31-LL_ssp245_10m",
...
```{r eval=FALSE}
future_slice <- region_slice(time_ce = 2030,
...
```{r eval=FALSE}
future_series <- region_series(dataset="WorldClim_2.1_HadGEM3-GC31-LL_ssp245_10m",
                              bio_variables = c("bio01","bio02"))
```

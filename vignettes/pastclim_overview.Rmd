...
# Random sampling of background (there is a bug in terra that prevents this section from working)

# if you get a "negative probability" error when sampling, you are using the new version of terra with the bug

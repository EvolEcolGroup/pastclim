...
NOTE: there is a but in `terra` version 1.6.17 (the current CRAN version) that 
leads to an error when sampling a raster ("Error: negative probability"). If you
encounter this error, you need to downgrade `terra` to 1.6.7 (or 1.6.3 on OSx).
See the README file.

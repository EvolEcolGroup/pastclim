...
"./inst/extdata/variable_table.csv".
...
3) Once you have added lines detailing the variables in your dataset, run the script "./raw-data/dataset_list_included.R" to store

...
```{r}
head(read.csv(system.file("rawdata_scripts/data_files/dataset_list_included.csv",
...
3) Once you have added lines detailing the variables in your dataset, run the script "./inst/rawdata_scripts/create_getOption("pastclim.dataset_list").R" to store

...
cdo("-z zip_9", select_string, "Beyer2022h_all_vars_v1.0.0.nc", "Beyer2022h_annual_vars_v1.1.0_temp.nc")
nc_in <- ncdf4::nc_open("Beyer2022h_annual_vars_v1.1.0_temp.nc", write = TRUE)
...
ncdf4::ncvar_put(nc_in, varid = "time", vals = get_time_bp_steps("custom", "Beyer2022h_annual_vars_v1.1.0_temp.nc"))
ncdf4::ncatt_put(nc_in, varid = "time", attname = "units", attval = "years since 1950-01-01 00:00:00.0")
ncdf4::ncatt_put(nc_in, varid = "time", attname = "long_name", attval = "years BP")
ncdf4::nc_close(nc_in)

cdo("-z zip_9 merge Beyer2022h_annual_vars_v1.1.0_temp.nc Beyer2020_topography_v1.0.0.nc Beyer2022h_annual_vars_v1.1.0.nc")
nc_in <- ncdf4::nc_open("Beyer2022h_annual_vars_v1.1.0.nc", write = TRUE)
...
select_string <- "-select,name=temperature,precipitation,cloudiness,relative_humidity,wind_speed"
cdo("-z zip_9", select_string, "Beyer2022h_all_vars_v1.0.0.nc", "Beyer2022h_monthly_vars_temp.nc")
cdo("splitlevel", "Beyer2022h_monthly_vars_temp.nc", "Beyer2022h_monthly")
for (i in 1:12) {
  if (i < 10) {
    month_id <- paste0("0", i)
  } else {
  ...
  file_name <- paste0("Beyer2022h_monthly", "0000", month_id)
...
cdo("-z zip_9", "merge", "*s.nc", "Beyer2022h_monthly_vars_v1.1.0.nc")

nc_in <- ncdf4::nc_open("Beyer2022h_monthly_vars_v1.1.0.nc", write = TRUE)
ncdf4::ncatt_put(nc_in,
  varid = 0, attname = "description",
...
ncdf4::ncatt_put(nc_in, varid = "time", attname = "long_name", attval = "years BP")
ncdf4::nc_close(nc_in)
unlink("Beyer2022h_monthly0*")
unlink("Beyer2022h_monthly_vars_temp.nc")

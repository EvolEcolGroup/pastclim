...
for (i in (dir("./original_files/")[34:36])){
  ...
  cdo ("-z zip_9 div -selname,mo_npp",file.path("./original_files",i),
       " krapp_land_only.nc ", new_filename)} else
       { cdo ("-z zip_9 div",file.path("./original_files",i),
...
for (outfile_name in c("Krapp2021_npp_monthly_v1.1.0.nc","Krapp2021_prec_monthly_v1.1.0.nc",

...
rm topography_*
cp topography.nc Krapp2021_topography_v1.0.0.nc
# remove unnecessary fields
ncatted -a history,global,d,, -a history_of_appended_files,global,d,, -a created_by,global,d,, -a date,global,d,, -h Krapp2021_topography_v1.0.0.nc 
ncatted -a created_by,global,c,c,'Andrea Manica' -a pastclim_version,global,c,c,'1.0.0' -a link,global,a,c,'https://github.com/EvolEcolGroup/pastclim' -a description,global,a,c,'Topographic varibles computed for the Krapp et al 2021, with icesheets and internal seas removed, to be used by the R library pastclim'  -h Krapp2021_topography_v1.0.0.nc
ncatted -a command_line,global,c,c,"./inst/rawdata_scripts/extract_topography_for_krapp2021_part1.R ./inst/rawdata_scripts/extract_topography_for_krapp2021_part2.sh" -h Krapp2021_topography_v1.0.0.nc

...
# create landmask
cdo("select,name=biome ./original_files/vegetation/biome4output_800ka.nc krapp_biome.nc")
...
for (file_id in list.files(download_dir,full.names = TRUE)){
  ...
  cdo(paste0("-z zip_9 div ",file_id," krapp_land_only.nc ",new_file_cut))
...
if (file.exists("./original_files/vegetation/biome4output_800ka.nc")){
  file.copy("./original_files/vegetation/biome4output_800ka.nc",

...
#' icesheets.
#' LIMITATIONS: The landmask will show internal lakes/seas as land, as their level
...
#' land mask does not include icesheets. This means that some areas that are permanently
...
#' need to be modified to include the appropriate icesheets.
#'

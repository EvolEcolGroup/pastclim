...
#'
#'
#' @note There is a missing time slice at -130 years BP for `temperature_min_07`
#' and `temperature_max_07` on the CHELSA server. That timestep is replaced with
#' -120 years BP in `pastclim` for those two variables.

...
tavg_series <- region_series(bio_variables =tavg_vars,
                             ...
                             dataset = "Beyer2020",
                              ext = sea_ext)
```
In this vignette, we will fetch pre-generated series stored in the package
```{r}
#fetch the data
...
high_res_file <- "../../../../project_temp/climate_downscale/worldclim_monthly/wc_tavg_5_monthly.nc"
tavg_obs_hres_series <- terra::rast(high_res_file)
...
```{r, fig.width=4, fig.height=4}
high_res_file <- "../../../../project_temp/climate_downscale/worldclim_monthly/wc_prec_5_monthly.nc"
prec_obs_hres_series <- terra::rast(high_res_file)

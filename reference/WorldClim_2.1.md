...
WorldClim version 2.1 is a database of high spatial resolution global
...
1970-2000, and are available at multiple resolutions of 10 arc-minutes,
5 arc-minutes, 2.5 arc-minute and 0.5 arc-minutes. The resolution of
interest can be obtained by changing the ending of the dataset name
...
`pastclim`, the datasets are given a date of 1985 CE (the mid-point of
the period of interest). There are 19 “bioclimatic” variables, as well
as monthly estimates for minimum, mean, and maximum temperature, and
precipitation.
...
"HadGEM3-GC31-LL", "INM-CM5-0", "IPSL-CM6A-LR", "MIROC6",
"MPI-ESM1-2-HR", "MRI-ESM2-0", and "UKESM1-0-LL". For SSP, use:
"ssp126", "ssp245", "ssp370", and "ssp585". RES takes the same values as
for present reconstructions (i.e. "10m", "5m", "2.5m", and "0.5m").
Example dataset names are *WorldClim_2.1_ACCESS-CM2_ssp245_10m* and
*WorldClim_2.1_MRI-ESM2-0_ssp370_5m*. Four combination (namely
*FIO-ESM-2-0_ssp370*, *GFDL-ESM4_ssp245*, *GFDL-ESM4_ssp585*, and
...
are selected as usual by defining the time in functions such as

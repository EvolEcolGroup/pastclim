...
test_that("load_dataset_list", {
  ...
  expect_identical(load_dataset_list(on_cran=TRUE)$dataset_list_v[1],
                   utils::read.csv(system.file("rawdata_scripts/data_files/dataset_list_included.csv",
                                                package="pastclim"))$dataset_list_v[1])
  # now create a file in the tempdir
  new_table <- utils::read.csv(system.file("rawdata_scripts/data_files/dataset_list_included.csv",
                                           package="pastclim"))
